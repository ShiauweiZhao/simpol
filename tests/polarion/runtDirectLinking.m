function results = runtDirectLinking(URL, Project, User, Pass)
...
%runtDirectLinking(URL of the server, Project name, Username, Password). 
...
suite2 = TestSuite.fromClass(?tDirectLinking,'ExternalParameters',param);
results = suite2.run;
end
